...
- [ ] Version marker + run-time version check (Craig-approved 2026-08-13; rides alongside the v0.1.1 closing session, marker amended into workstream A) -> `~/.claude/plans/foundry-version-check.md`
