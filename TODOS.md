...
- [ ] Phase 13: Publish (fresh-repo swap + flip public) -> `~/.claude/plans/foundry-phase-13-publish.md` (IRREVERSIBLE; explicit go-ahead required; depends on Phase 12.9, now merged; runbook hardened by two adversarial passes 2026-07-13)
