...
make validate       # in that order: one gate reads the BUILT site. Reports
                    # against the schema, bundled-copy and version-marker sync,
                    # and the brand assets against the design-kit pin.
```
